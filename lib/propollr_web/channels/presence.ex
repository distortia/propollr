defmodule PropollrWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Propollr.MyChannel do
        use PropollrWeb, :channel
        alias Propollr.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :propollr,
                        pubsub_server: Propollr.PubSub
end
