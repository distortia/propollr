defmodule Propollr.Veil do
  @moduledoc """
  Veil's main context
  """
  alias Propollr.Repo
  alias Propollr.Veil.{User, Request, Session}
  alias PropollrWeb.Veil.{Mailer, LoginEmail}
  alias Veil.Secure
  ...
  def verify(%Session{} = session) do
    verify(PropollrWeb.Endpoint, session)
  end

  def verify(%Request{} = request) do
    verify(PropollrWeb.Endpoint, request)
  end
